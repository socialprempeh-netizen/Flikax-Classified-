...
export function ListingForm({
  ...
  if (posted) {
    return (
      <div className="rounded-2xl border border-neutral-100 bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
  ...
  return (
    <div className="space-y-4">
      ...
      {step === 1 && (
        <form
          onSubmit={handleNext}
          className="space-y-6 rounded-2xl border border-neutral-100 bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.15)]"
        >
          <div>
            <h1 className="text-xl font-bold text-neutral-800">
