...
export function StartChatButton({ listingId }: { listingId: string }) {
  return (
    <form action={startOrGetConversationAction.bind(null, listingId)}>
      <button
        type="submit"
        className="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-slate-strong px-4 py-2.5 text-base font-bold text-neutral-700 hover:bg-neutral-50"
      >
